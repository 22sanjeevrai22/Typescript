            ...
            <div className="d-flex align-items-center py-3 py-lg-0">
              <div className="me-3">
                ...
                <div className="menu menu-sub menu-sub-dropdown menu-column w-350px w-lg-375px">
                  ...
                  <div className="tab-content">applee</div>
                </div>
              </div>
              <div className="me-3">
                <a
              ...
              <div className="d-flex align-items-center me-3">
                ...
                <div className="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-title-gray-700 menu-icon-muted menu-active-bg menu-state-color fw-semibold py-4 fs-base w-175px">
